...
namespace Unity.Physics.Authoring
{
    public abstract class BaseJoint : MonoBehaviour
    {
        ...
        protected void CreateJointEntity(BlobAssetReference<JointData> jointData, EntityManager entityManager)
        {
        ...
        public abstract void Create(EntityManager entityManager);
